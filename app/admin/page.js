  ...
  return (
    <div className="p-6 md:p-10 animate-in fade-in duration-500">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-10">
          <div className="bg-white p-8 rounded-md shadow-sm border border-slate-200 relative overflow-hidden">
      ...
      {/* Area Panduan Cepat */}
      <div className="bg-white border border-slate-200 shadow-sm rounded-md p-8 md:p-10 relative overflow-hidden">
          <div className="absolute top-0 right-0 w-64 h-64 bg-emerald-50 rounded-md blur-[80px] pointer-events-none"></div>
          ...
          <ol className="list-decimal list-inside space-y-4 text-slate-600 text-sm md:text-base relative z-10 font-medium">
              <li className="p-2 hover:bg-slate-50 rounded-md transition">Masuk ke menu <b className="text-emerald-700">Sertifikat & Acara</b> dan klik tombol <b className="text-slate-900">+ Buat Baru</b>.</li>
              <li className="p-2 hover:bg-slate-50 rounded-md transition">Isi detail kegiatan dan lakukan <b className="text-emerald-700">Import file Excel</b> peserta.</li>
              <li className="p-2 hover:bg-slate-50 rounded-md transition">Klik tombol <b className="text-emerald-700">Kanvas Desain</b> pada kegiatan yang baru saja dibuat.</li>
              <li className="p-2 hover:bg-slate-50 rounded-md transition">Upload background A4 kosong, lalu geser nama dan QR code ke posisi yang tepat.</li>
              <li className="p-2 hover:bg-slate-50 rounded-md transition">Kembali ke tabel dan klik <b className="text-emerald-700">Generate & Kirim Email</b>.</li>
          </ol>
      </div>
    </div>
  );
